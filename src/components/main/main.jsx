                    ...
                    <Col xs={12} sm={6}  md={4} lg={2} className="ytd-item-render">
                        <div className="container-col">
                            <div className="video-div">
                                <img src={picturetest} alt="picturetest" className="picture-video"></img>
                            </div>
                            <div className="video-info-container">
                                <div className="title-div">
                                    <span className="title-video">Mix - Abraham Mateo, Farruko, Christian Daniel - Loco Enamorado Video Oficial</span>
                                </div>
